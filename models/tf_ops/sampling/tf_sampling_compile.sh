...
#g++ -std=c++11 tf_sampling.cpp tf_sampling_g.cu.o -o tf_sampling_so.so -shared -fPIC -I /home/kfaria/anaconda3/lib/python3.8/site-packages/tensorflow/include -I /cm/shared/apps/cuda11/11.1.0/include -I /home/kfaria/anaconda3/lib/python3.8/site-packages/tensorflow/include/external/nsync/public -lcudart -L /cm/shared/apps/cuda11/11.1.0/lib64/ -L /home/kfaria/anaconda3/lib/python3.8/site-packages/tensorflow/ -l tensorflow_framework -O2 -D_GLIBCXX_USE_CXX11_ABI=0
